...
This is quick 10 min tutorial that hopefully will help you use the Cloudinary API to allow users to upload images into your application using the traditional `<input type="file>`.
