...
---
 ...
 <div align="center">
 <img align="center" width="230" src="http://assets.breatheco.de/apis/img/images.php?blob&random&cat=icon&tags=4geeks,16" />
  <h2>HTML Hello!</h2>
...
## :seedling: How to start

First you have you choose if you are going to work locally (on your computer) or on Gitpod (on-line):

### **If you decide to work locally**:

:point_up_2: Make sure you have node.js in your computer or download it from here [from here](https://nodejs.org/en/download/

Next step would be cloning the (html boilerplate)[https://github.com/4GeeksAcademy/html-hello]
