...
---
 ...
 <img align="center" width="100" src="http://assets.breatheco.de/apis/img/images.php?blob&random&cat=icon&tags=4geeks,16" />
  <h2>Starting a project in Vanilla JS</h2>
  <blockquote>Start coding in 30 seconds by opening this template on gitpod</blockquote>
</div>
...
The first step to start coding is cloning the [vanilla.js boilerplate](https://github.com/4GeeksAcademy/vanillajs-hello.git)
...
2) Build the application for the first time...
